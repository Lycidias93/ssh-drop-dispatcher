...
ui_print "SSH Drop Dispatcher 4.12.2-webui-rc1"
ui_print "Runtime SoT: $STATE_DIR"
ui_print "Author: Lycidias93
Delivery safety target checks + break-glass SCP + delivery status/wait + ntfy notifications + space-probe retry + Sortify marker contract: final + WebUI ntfy settings rc1
