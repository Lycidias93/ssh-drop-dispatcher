...
ui_print "SSH Drop Dispatcher 4.12.1-delivery-safety-rc4"
ui_print "Runtime SoT: $STATE_DIR"
ui_print "Author: Lycidias93
Delivery safety target checks + break-glass SCP + delivery status/wait + ntfy notifications + space-probe retry + Sortify marker contract: rc4
...
ui_print "- Private runtime export prompt fix: rc4"
